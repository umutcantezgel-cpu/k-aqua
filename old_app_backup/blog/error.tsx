...
export default function BlogError({
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
      <Icon name="article" className="text-[64px] text-text-secondary mb-4" />
      <h2 className="text-2xl font-bold text-foreground mb-2">Blog konnte nicht geladen werden</h2>
