...
export default function HomeHeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] h-auto py-32 lg:py-0 flex items-center justify-center bg-slate-50 overflow-hidden py-20 lg:py-0 w-full min-w-0 max-w-full">
      ...
      <div className="w-full max-w-[1400px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10 w-full min-w-0 max-w-full flex flex-col justify-center min-h-[100svh] h-auto py-32 lg:py-0 py-20 lg:py-0">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center w-full min-w-0 max-w-full">
          {/* Content Left Side */}
          <motion.div 
            variants={containerVariants}
            initial="hidden"animate="visible"className="lg:col-span-7 flex flex-col items-start w-full min-w-0 max-w-full pt-10 lg:pt-0">
            {/* Top Badge */}
            ...
            <motion.div variants={itemVariants} className="w-full min-w-0 max-w-full overflow-hidden mb-6">
              <h1 className="text-[clamp(1.75rem,6vw,4.5rem)] leading-[1.05] tracking-tight  text-slate-900 font-bold w-full min-w-0 max-w-full overflow-hidden break-words hyphens-auto">
            ...
            <motion.div variants={itemVariants} className="w-full min-w-0 max-w-full overflow-hidden mb-10">
              <p className="text-[clamp(1rem,4vw,1.25rem)]  text-slate-600 max-w-[50ch] font-light leading-relaxed w-full min-w-0 max-w-full">
          ...
          <motion.div 
            ...
            className="lg:col-span-5 relative w-full min-w-0 max-w-full h-64 md:h-[40vh] sm:h-72 md:h-[50vh] lg:h-[70vh] mt-10 lg:mt-0 flex items-center justify-center">
            {/* The Glass Container */}
