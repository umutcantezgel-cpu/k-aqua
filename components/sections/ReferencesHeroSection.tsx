...
export default function ReferencesHeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[100svh] h-auto py-32 lg:py-0 flex flex-col items-center justify-center bg-[#FAFAFA] overflow-hidden">
      ...
      <motion.div 
        className="relative z-10 max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-12 w-full flex-1 flex flex-col items-center justify-center text-center min-w-0 max-w-full pt-24 pb-16"variants={containerVariants}
      ...
      >
        ...
        <motion.div variants={itemVariants} className="w-full min-w-0 max-w-full flex justify-center px-4 sm:px-0">
          <div className="w-full min-w-0 max-w-full overflow-hidden">
            <p className="text-[clamp(1rem,2vw,1.25rem)] mx-auto text-slate-500 max-w-3xl leading-[1.6]  font-medium">
              {t('description')}
            </p>
          </div>
        </motion.div>
