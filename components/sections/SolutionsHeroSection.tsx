...
export default function SolutionsHeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col justify-center overflow-hidden bg-[#fafafa]">
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 relative z-10 w-full min-w-0 max-w-full flex-1 flex flex-col justify-center py-32">
        <motion.div 
          className="w-full min-w-0 max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center"
        ...
        >
          <div className="lg:col-span-8 flex flex-col items-start text-left w-full min-w-0 max-w-full">
            ...
            <motion.div variants={itemVariants} className="w-full min-w-0 max-w-full overflow-hidden">
              <h1 className="w-full min-w-0 max-w-full overflow-hidden text-[clamp(1.75rem,6vw,4.5rem)] leading-[1.05] tracking-tight text-balance text-slate-900 mb-6 sm:mb-8">
            ...
            <motion.div variants={itemVariants} className="w-full min-w-0 max-w-full overflow-hidden">
              <p className="w-full min-w-0 max-w-[42ch] text-lg sm:text-xl md:text-[clamp(1.125rem,2vw,1.5rem)] text-slate-500 leading-relaxed text-balance font-light border-l-[3px] border-blue-500/20 pl-6 sm:pl-8 py-2">
                {t("Hero.subtitle")}
              </p>
            </motion.div>
          </div>
          ...
          >
            ...
            <div className="relative w-48 h-48 sm:w-64 sm:h-64 md:w-[22rem] md:h-[22rem]">
              <div className="absolute inset-0 rounded-full border-[1px] border-slate-200/50 backdrop-blur-3xl shadow-2xl flex items-center justify-center bg-white/40">
                <div 
                  className="w-24 h-24 sm:w-32 sm:h-32 md:w-48 md:h-48 rounded-full bg-gradient-to-tr from-blue-500 to-sky-400 blur-2xl animate-pulse"
